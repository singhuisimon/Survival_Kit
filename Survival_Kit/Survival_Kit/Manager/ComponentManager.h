...
namespace gam300 {
	...
	public:
		...
		virtual Component *get_raw(EntityID) = 0;
		virtual Component const *get_raw(EntityID) const = 0;
	};
	...
	public:
		...
		Component *get_raw(EntityID eid) override {
			return m_component_pool.get(eid);
		}
		Component const *get_raw(EntityID eid) const override {
			return m_component_pool.get(eid);
		}
