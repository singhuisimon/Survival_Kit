...
namespace gam300 {
    ...
    void ImguiManager::displayPerformanceProfile()
    {
        ...
        ImGui::SetNextWindowSize(ImVec2(400, 300), ImGuiCond_FirstUseEver); //make window size bigger

        if (ImGui::Begin("Performance Profile", &hierachyWindow, ImGuiWindowFlags_NoCollapse))
        {
            //Tracy profiler button (not sure what to do with this for now...) - rio
