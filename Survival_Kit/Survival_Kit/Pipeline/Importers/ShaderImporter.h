 ...
 * @brief Declares the shader importer class.
...
namespace gam300 
{
    ...
    public:
        ...
        /**
         * @brief Checks if the importer supports the given shader file extension.
         * @param ext The file extension (e.g., ".hlsl", ".glsl").
         * @return True if the file type is supported.
         */
        bool CanImport(const std::string& ext) const override;

        /**
         * @brief Imports the shader file into the intermediate directory.
