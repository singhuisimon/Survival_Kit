/**
 * @file MeshImporter.h
 * @brief Declares the mesh asset importer class.
...
namespace gam300 {
    ...
    public:
        ...
        /**
         * @brief Checks if the importer supports the given mesh file extension.
         * @param ext The file extension (e.g., ".obj", ".fbx").
         * @return True if the file type is supported.
         */
        bool CanImport(const std::string& ext) const override;

        /**
         * @brief Imports the mesh and copies it into the intermediate directory.
