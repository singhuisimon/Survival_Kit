 ...
 * @brief Declares the audio asset importer class.
...
namespace gam300 
{
    ...
    public:
        ...
        /**
         * @brief Checks if the importer supports the given audio file extension.
         * @param ext The file extension (e.g., ".wav", ".mp3").
         * @return True if the file type is supported.
         */
        bool CanImport(const std::string& ext) const override;

        /**
         * @brief Imports the audio file and copies it into the intermediate directory.
